...
public class GetDanScoreQueryHandler(ILogger<GetDanScoreQueryHandler> logger, ITaikoDbContext context)
    : IRequestHandler<GetDanScoreQuery, CommonDanScoreDataResponse>
{
