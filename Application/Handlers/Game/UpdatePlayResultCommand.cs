    ...
    : IRequestHandler<UpdatePlayResultCommand, uint>
{
    ...
    private async Task UpdateAiBattleData(CommonPlayResultData playResultData, CommonPlayResultData.StageData stageData)
    {
            ...
            var aiSections = stageData.ArySectionDatas.Select((data, i) =>
                {
                    ...
                    UpdateSectionBest(section, data);
                    return section;
                }
            );
        ...
        for (var index = 0; index < stageData.ArySectionDatas.Count; index++)
        {
            ...
            {
                UpdateSectionBest(existing.AiSectionScoreData[index], sectionData);
            }
            else
            {
                ...
                UpdateSectionBest(aiSectionScoreDatum, sectionData);
    ...
    private static void UpdateSectionBest(AiSectionScoreDatum datum, CommonPlayResultData.AiStageSectionData sectionData)
    {
        ...
        datum.IsWin = sectionData.IsWin || datum.IsWin;
